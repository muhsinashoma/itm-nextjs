...
export function Sidebar({
    ...
    const currentUser =
        getUser() as AuthMeData | null;

    const canUseUserPanel =
        canAccessUserPanel(
            currentUser
        );
        ...
        <aside className="flex h-full w-full flex-col bg-card text-foreground">
            ...
            <div className="shrink-0 border-t border-border px-2 py-1.5">
                <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-64 border border-border bg-card text-card-foreground">
                        <DropdownMenuLabel className="font-normal">
