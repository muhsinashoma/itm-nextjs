...
//                Do not rely only on role_code.

//                ROOT currently receives permissions such as:
//                panel.user.access
//                roles.manage
//                panel.admin.access
//                etc.

//                This makes the header follow the actual RBAC
//                configuration returned by /auth/me.
//             ====================================================== */
...
//                ROOT / PERMITTED ADMIN ALSO GETS
//                --------------------------------
//                User Panel
//                Role Access

//                Logout is rendered after all nav links.
//             ====================================================== */
...
//                          * General User area.
//                          *
//                          * ROOT may also enter /dashboard/user.
//                          * In that case useUserShell=true and the
//                          * header behaves like the User Panel.
//                          */
//                         if (
//                             useUserShell
//                         ) {
...
//                             /*
//                              * ROOT / admin with panel.admin.access
//                              * can return to the Admin Dashboard
//                              * while browsing User Panel.
//                              */
//                             if (
//                                 permissions.has(
//                                     "panel.admin.access"
...
//                         /*
//                          * ROOT / whoever has panel.user.access
//                          * receives User Panel link.
//                          */
//                         if (
//                             canOpenUserPanel
//                         ) {
...
//                         /*
//                          * ROOT / whoever has roles.manage
//                          * receives Role Access.
//                          */
//                         if (
//                             canManageRoles
//                         ) {
