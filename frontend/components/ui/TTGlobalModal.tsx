            ...
            >
                ...
                <div className="max-h-[70vh] overflow-y-auto p-5">
                    ...
                    <div className="mt-4 rounded-xl border p-4 bg-background">
                        ...
                        <div className="mt-4 rounded-xl border border-slate-200 bg-slate-50/70 p-3.5 dark:border-slate-800 dark:bg-slate-950/30">
                            ...
                            <p className="mt-2 whitespace-pre-wrap break-words text-xs leading-5 text-foreground">
                                {data?.description?.trim() ||
                                    "No query description was provided."}
                            </p>
