...
>) {
    ...
    /*
     * Action dialogs always win over the row hover preview.
     * Clear both the visible card and any delayed hover timer as
     * soon as Assign / Reassign / Requisition / Close opens.
     */
    React.useEffect(() => {
        if (!actionDialogOpen) {
            return;
    ...
    }, [actionDialogOpen, hideHoverPreview]);
        ...
        <div className="w-full min-w-0 space-y-2.5">
            ...
            >
                ...
                <TroubleTicketHoverPreview
                    ...
                    visible={
                        !actionDialogOpen && hoverPreviewVisible
                    }
                    position={
                        actionDialogOpen
                            ? null
