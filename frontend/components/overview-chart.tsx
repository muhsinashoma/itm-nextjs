...
function PieValueLabel(props: any) {
    ...
    const x =
        Number(cx ?? 0) +
        radius * Math.cos(-Number(midAngle ?? 0) * radian);

    const y =
        Number(cy ?? 0) +
        radius * Math.sin(-Number(midAngle ?? 0) * radian);
...
export default function OverviewChart() {
    ...
    const [trendSource, setTrendSource] =
    ...
    useEffect(() => {
        ...
        async function loadTroubleTicketSummary() {
            try {
                ...
                const response =
                    await dashboardApi.troubleTicketSummary();
                ...
                setTicketSummary({
                    opened_today: Number(
                        response.data?.opened_today ?? 0
                    ),
                    closed_today: Number(
                        response.data?.closed_today ?? 0
                    ),
                    total_running_tt: Number(
                        response.data?.total_running_tt ?? 0
                    ),
                ...
                setTicketSummary(EMPTY_SUMMARY);
    ...
    /* ---------------------------------------------------------------------- */
    /* Load selected-period data for all chart types                          */
    /* ---------------------------------------------------------------------- */
    ...
    const currentData =
        useMemo<TroubleTicketMetric[]>(
            () => [
                {
                    label: "TT Opened Today",
                    shortLabel: "Opened Today",
                    description:
                ...
                {
                    label: "TT Closed Today",
                    shortLabel: "Closed Today",
                    description:
                ...
                {
                    label: "Total Running TT",
                    shortLabel: "Running TT",
                    description:
                ...
                {
                    label: "Total Procurement TT",
                    shortLabel: "Procurement TT",
                    description:
    ...
    //         () => [
    //             {
    //                 label: `Opened - ${selectedRangeLabel}`,
    //                 shortLabel: "Opened",
    //                 description:
    //                     `Opened during ${selectedRangeLabel.toLowerCase()}`,
    //                 value: rangeOpenedTotal,
    //                 color: COLORS.opened,
    //                 dotClass: "bg-blue-600",
    //                 valueClass:
    //                     "text-blue-600 dark:text-blue-400",
    ...
    //             },
    //             {
    //                 label: `Closed - ${selectedRangeLabel}`,
    //                 shortLabel: "Closed",
    //                 description:
    //                     `Closed during ${selectedRangeLabel.toLowerCase()}`,
    //                 value: rangeClosedTotal,
    //                 color: COLORS.closed,
    //                 dotClass:
    //                     "bg-emerald-500",
    //                 valueClass:
    ...
    //                 shortLabel: "Running TT",
    //                 description:
    //                     "Latest running workload",
    //                 value:
    //                     latestTrendItem?.Running ??
    //                     ticketSummary.total_running_tt,
    //                 color: COLORS.running,
    //                 dotClass: "bg-amber-500",
    //                 valueClass:
    ...
    //                     "Procurement TT",
    //                 description:
    //                     "Latest procurement workload",
    //                 value:
    //                     latestTrendItem?.Procurement ??
    //                     ticketSummary
    //                         .total_procurement_tt,
    //                 color: COLORS.procurement,
    //                 dotClass:
            ...
            () => [
                {
                    label: "Opened Today",
                    shortLabel: "Opened Today",
                    description: "Tickets registered today",
                    value: ticketSummary.opened_today,
                    color: COLORS.opened,
                    dotClass: "bg-blue-600",
                    valueClass:
                        "text-blue-600 dark:text-blue-400",
                ...
                },
                {
                    ...
                    value: ticketSummary.closed_today,
                    color: COLORS.closed,
                    dotClass: "bg-emerald-500",
                    valueClass:
                        "text-emerald-600 dark:text-emerald-400",
                ...
                },
                {
                    label: "Running TT",
                    shortLabel: "Running TT",
                    description: "Current running workload",
                    value:
                        ticketSummary.total_running_tt,
                    color: COLORS.running,
                    dotClass: "bg-amber-500",
    ...
    const selectedRangeMaximum =
        Math.max(
            ...selectedRangeData.map(
                (item) => item.value
            ),
            1
        );
        ...
        <div>
            ...
            <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
                <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">
                        Current activity, workload and historical performance
                    </p>
                </div>
            </div>
            ...
            <div className="rounded-xl border border-border bg-muted/10 p-3">
                ...
                {trendLoading ? (
                    ...
                    <div className="flex h-[320px] items-center justify-center rounded-lg border border-red-200 bg-red-50 px-4 text-center text-xs text-red-700">
                        {trendError}
                    </div>
                ) : noTrendData ? (
                    <div className="flex h-[320px] flex-col items-center justify-center rounded-lg border border-dashed border-border text-center">
