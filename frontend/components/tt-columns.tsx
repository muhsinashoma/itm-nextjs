...
// //     const date = `${getPart(dateParts, "year")}-${getPart(
// //         dateParts,
// //         "month"
// //     )}-${getPart(dateParts, "day")}`;

// //     const time = `${getPart(timeParts, "hour")}:${getPart(
// //         timeParts,
// //         "minute"
...
// //                         "
// //                     >
// //                         <span className="whitespace-nowrap font-mono text-[10px] font-semibold tabular-nums tracking-[-0.1px] text-foreground">
// //                             {created.date}
// //                         </span>

// //                         {created.time && (
// //                             <span className="mt-0.5 whitespace-nowrap font-mono text-[9px] font-medium tabular-nums text-muted-foreground">
// //                                 {created.time}
// //                             </span>
// //                         )}
// //                     </div>
...
//    Row hover preview is intentionally handled by DataTable.
//    Keeping TT-specific hover state out of this file guarantees
//    that only one preview can exist for a row at a time.
// ============================================================ */
