...
//         description:
//             "Approved IT Accessories requisitions ready for allocation or delivery",

//         emptyTitle:
//             "No Approved Requisitions",

//         emptyDescription:
//             "There are currently no approved requisitions.",
//     },
...
//                                                     resetColumns
//                                                 }
//                                                 className="mt-1 w-full border-t border-border px-2 py-2 text-left text-[10px] text-muted-foreground hover:text-foreground"
//                                             >
//                                                 Reset Default
//                                             </button>
//                                         </div>
...
//                                                     <th className="px-2 py-2 text-left text-[10px]">
//                                                         TT No
//                                                     </th>
...
//                                                                             )
//                                                                         }
//                                                                         className="inline-flex items-center gap-1 rounded border border-emerald-300 bg-emerald-50 px-2 py-1 text-[10px] font-semibold text-emerald-700 transition-colors hover:bg-emerald-600 hover:text-white dark:border-emerald-900/60 dark:bg-emerald-950/30 dark:text-emerald-400"
//                                                                     >
//                                                                         <Eye className="h-2.5 w-2.5" />
