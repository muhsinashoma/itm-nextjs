...
//                     serviceRequestRes,
//                 ] = await Promise.allSettled([
//                     dashboardApi.summary(),              // API component for dashboard summary
//                     reportApi.nonOperationalSummary(),   // API component for non-operational summary
//                     reportApi.warrantySummary(),         // API component for warranty summary
//                     reportApi.serviceRequestSummary(),   // API component for service request summary
//                 ]);

//                 if (!mounted) return;

//                 /*
//                  * Dashboard, Warranty and Service Request
//                  * summaries must all succeed.
//                  */
//                 if (
...
//                 ) {
//                     console.error(
//                         "[dashboard] summary loading failed:",
//                         {
//                             dashboard:
...
//                             warranty:
//                                 warrantyRes.status === "rejected"
//                                     ? warrantyRes.reason
//                                     : null,

//                             serviceRequest:
//                                 serviceRequestRes.status === "rejected"
//                                     ? serviceRequestRes.reason
//                                     : null,
//                         }
//                     );

//                     setError(
//                         "Unable to load warranty or service request summary"
//                     );
...
//                 /*
//                  * Keep your existing non-operational
//                  * summary block below this point.
//                  */
//                 if (nonOpRes.status === "fulfilled") {
//                     const raw: any = nonOpRes.value.data;
//                     const data =
