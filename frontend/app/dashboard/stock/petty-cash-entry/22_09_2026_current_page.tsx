...
export default function PettyCashStockEntryPage() {
    ...
    const [commitError, setCommitError] =
        useState("");
    ...
    function validateClient() {
        ...
        if (incomplete >= 0) {
            setError(
                `Complete Category, Brand, Model, Serial No., Purchase Date, Warranty and Vendor for Row #${
                    incomplete + 1
                }.`
            );
            return false;
            ...
            {reviewOpen && validation && (
                <div className="fixed inset-0 z-[300] flex items-center justify-center bg-black/50 p-4 backdrop-blur-[2px]">
                    <div className="flex max-h-[90vh] w-full max-w-3xl flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-2xl">
                        ...
                        {commitError && (
                            <div className="mx-5 mb-4 rounded-xl border border-red-200 bg-red-50 px-3 py-3 text-[9px] text-red-800">
                                <p className="font-bold">
                                    Unable to save Petty Cash stock
                                </p>
                                ...
                                <p className="mt-1 text-[8px] text-red-700/80">
                                    Nothing was committed. The database transaction was rolled back safely.
                                </p>
                            </div>
                        )}
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                {validation.can_import && (
                                    ...
                                    >
                                        ...
                                        Confirm & Save {validation.new_count} New Item
                                        {validation.new_count ===
                                        1
                                            ? ""
                                            : "s"}
