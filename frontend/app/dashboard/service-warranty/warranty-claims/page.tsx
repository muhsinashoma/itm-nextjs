    ...
    return (
        <>
            <button
                ...
                type="button"
                onClick={toggleMenu}
                className="inline-flex min-w-[86px] items-center justify-center gap-1 rounded-lg border border-border bg-muted px-2.5 py-1 text-[11px] font-medium text-foreground transition hover:bg-border"
            >
                Actions
                <ChevronDown size={12} />
            </button>
                            ...
                            <tr className="bg-[#DDE4E7]">
                                ...
                                <th
                                    ...
                                    className="
                                        ...
                                        border-b-slate-400 px-3 py-3 text-center
                                        text-[10px] font-bold uppercase
                                        tracking-[0.06em] text-slate-800
                                    "
                                >
                            ...
                            {loading ? (
                                ...
                                rows.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="w-[124px] whitespace-nowrap border-l border-slate-200/80 px-3 py-2.5 text-center align-middle">
