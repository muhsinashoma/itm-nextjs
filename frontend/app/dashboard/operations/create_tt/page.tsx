...
//             //1st argument = payload, 2nd argument = attachments
//             const response =
//                 await ticketApi.createBulk(
//                     payload,
//                     attachments
    ...
    return (
        <div>
            ...
            <textarea
                ...
                placeholder="Describe the issue..."
                className={`w-full resize-none rounded-md border border-slate-200 bg-white px-2.5 text-xs text-slate-700 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 disabled:bg-slate-50 ${compact
                        ? "h-8 py-1.5 leading-5"
                        : "h-[82px] py-2.5 leading-5"
                    }`}
            />
