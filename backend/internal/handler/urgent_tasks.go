...
// //         WHERE employee_id = $1
// //           AND BTRIM(COALESCE(active, '')) IN ('Active', 'Yes')
// //         LIMIT 1
// //     `, req.AssignedTo).Scan(&assignedName)
// // 	if err != nil {
// // 		if err == pgx.ErrNoRows {
// // 			response.BadRequest(c, "selected employee is not active or does not exist")
// // 			return
// // 		}
// // 		response.ServerError(c, err)
// // 		return
...
// //             CASE WHEN $4 = 'Completed' THEN $8 ELSE NULL END
// //         )
// //         RETURNING
// //             id,
// //             reference,
...
// //             END,
// //             completed_by = CASE
// //                 WHEN $4 = 'Completed' THEN COALESCE(completed_by, $8)
// //                 ELSE NULL
// //             END
