...
import {
    ...
    useReportingYear,
} from "@/lib/reporting-year";


export function RightSidebar() {
    const router = useRouter();
    const selectedYear = useReportingYear();
    const reportingYearRange = getReportingYearRange(
        selectedYear
    );
            ...
            try {
                ...
                const [
                    ...
                    dashboardApi.troubleTickets({
                        ...
                        status: "all",
                        from_date:
                            reportingYearRange.fromDate,
                        to_date:
                            reportingYearRange.toDate,
                    }),
    ...
    return (
        ...
        >
                    ...
                    <div className="flex min-w-0 items-center gap-2">
                        ...
                        <div className="min-w-0">
                            <h4
                                ...
                                "
                            >
                                Departmental TT — {selectedYear}
                            </h4>

                            <p className="mt-0.5 text-[8.5px] text-muted-foreground">
                                Top departments by tickets in {selectedYear}
                            </p>
                        </div>
                    </div>
                ...
                <div className="min-w-0 overflow-visible px-2.5 pt-2 pb-2.5">
                    {todayTTLoading ? (
                        ...
                        <div
                            ...
                            "
                        >
                            No department tickets found for {selectedYear}.
                        </div>
                    ) : (
            ...
            >
                ...
                >
                    TT Creators — {selectedYear} from IT
                </h4>
