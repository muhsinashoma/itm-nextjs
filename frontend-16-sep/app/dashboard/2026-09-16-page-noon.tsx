...
export default function DashboardPage() {
    ...
    /* ========================================================
       GLOBAL REPORTING YEAR

       Changing the header year resets local TT date overrides so
       the table immediately reflects the complete selected year.
       Other TT filters remain intact.
       ======================================================== */
