...
//                             View and manage employee joining and exit IT lifecycle tasks.
//                         </p>
//                     </div>
...
//                             counts.completed
//                         }
//                         description="Lifecycle tasks completed"
//                     />
//                 </div>
...
//                                     )
//                                 }
//                                 placeholder="Search employee name, employee ID or reference..."
//                                 className="h-10 pl-9"
//                             />
//                         </div>
...
//                                     Selected checklist items are visible here. Open a record for the assigned IT employee to update and complete the task.
//                                 </p>
//                             </div>
...
//                                 Change the filters or create a new employee IT lifecycle task.
//                             </p>
//                         </div>
//                     ) : (
...
//                           "Device",
//                       required:
//                           item.joining_device_required,
//                       completed:
//                           item.joining_device_completed,
//                   },
//                   {
//                       label:
//                           "VPN",
//                       required:
//                           item.joining_vpn_required,
//                       completed:
//                           item.joining_vpn_completed,
//                   },
//                   {
//                       label:
//                           "IP Phone",
//                       required:
//                           item.joining_ip_phone_required,
//                       completed:
//                           item.joining_ip_phone_completed,
//                   },
//                   {
//                       label:
//                           "Printer",
//                       required:
//                           item.joining_printer_required,
//                       completed:
//                           item.joining_printer_completed,
//                   },
//                   {
//                       label:
//                           "Security",
//                       required:
//                           item.joining_endpoint_security_required,
//                       completed:
//                           item.joining_endpoint_security_completed,
//                   },
//                   {
//                       label:
//                           "Card",
//                       required:
//                           item.joining_card_access_required,
//                       completed:
//                           item.joining_card_access_completed,
//                   },
//               ].filter(
//                   (
//                       entry
...
//                 {item.checklist_completed_count}/
//                 {item.checklist_required_count} completed
//             </p>
//         </div>
//     );
// }
                    ...
                    {loading ? (
                        ...
                        <>
                            {/* =================================================
                                ...
                                Fixed grid: no min-width and no horizontal scroll.
                            ================================================= */}
                            ...
                            <div className="hidden xl:block">
                                <div
                                    className="
                                        grid
                                        grid-cols-[38px_104px_minmax(190px,1.35fr)_80px_112px_minmax(110px,0.8fr)_minmax(155px,1.1fr)_118px]
                                        items-center
                                        gap-2.5
                                        border-b
                                        border-border
                                    ...
                                    {items.map(
                                        (
                                            ...
                                            >
                                                ...
                                                <div className="min-w-0">
                                                    <p className="truncate font-mono text-[11px] font-bold text-primary">
                                                        {item.reference_no ||
                                                            `#${item.id}`}
                                                    </p>
                                                </div>
                                                ...
                                                <div className="min-w-0">
                                                    ...
                                                    <p className="mt-0.5 whitespace-nowrap text-xs font-semibold text-foreground">
                                                        {formatDate(
                                                            item.resignation_date
                                                        )}
                                                    </p>
                            ...
                            {/* =================================================
                                TABLET / SMALL SCREEN
                                Card layout prevents horizontal scrolling.
                            ================================================= */}
...
function ListHead({
    ...
    return (
        <div className="min-w-0 text-[10px] font-semibold uppercase tracking-wide text-muted-foreground">
            {children}
        </div>
    );
}
